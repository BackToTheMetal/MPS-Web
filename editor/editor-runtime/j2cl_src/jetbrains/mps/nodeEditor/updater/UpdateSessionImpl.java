...
public class UpdateSessionImpl implements UpdateSession {
  ...
  private Map<SNode, EditorCell> myBigCellsMap;
  ...
  protected UpdateSessionImpl(@NotNull SNode node, List<SModelEvent> events, @NotNull UpdaterImpl updater, Map<SNode, EditorCell> bigCellsMap,
  ...
  private String[] getInitialEditorHints(EditorContext editorContext) {
    ...
    HintsState state = ConceptEditorHintSettingsComponent.getInstance().getState();
  ...
  public void registerAsBigCell(EditorCell cell) {
    myBigCellsMap.put(cell.getSNode(), cell);
  }
