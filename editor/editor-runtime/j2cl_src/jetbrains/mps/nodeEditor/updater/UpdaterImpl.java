...
public class UpdaterImpl implements Updater {
  ...
  private Map<SNode, EditorCell> myBigCellsMap = new HashMap<>();
  private Map<EditorCell, Set<SNode>> myRelatedNodes = new HashMap<>();
  private Map<EditorCell, Set<SNodeReference>> myRelatedRefTargets = new HashMap<>();
...
//    myUpdateInfoIndex = null;
  ...
  public EditorCell getBigCell(SNode node) {
    assert !myDisposed;
    EditorCell editorCell = myBigCellsMap.get(node);
    return editorCell;
  }
