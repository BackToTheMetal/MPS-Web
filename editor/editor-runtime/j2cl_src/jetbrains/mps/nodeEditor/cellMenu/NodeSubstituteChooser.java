...
public class NodeSubstituteChooser implements KeyboardHandler {
  ...
  private void initList() {
    myList = new JList<>(new DefaultListModel<SubstituteAction>());
  ...
  private void doRebuildMenuEntries(List<SubstituteAction> matchingActions) {
    ...
    DefaultListModel<SubstituteAction> model = getListModel();
    model.removeAllElements();
    for (SubstituteAction action : mySubstituteActions) {
  ...
  private DefaultListModel<SubstituteAction> getListModel() {
    return (DefaultListModel<SubstituteAction>) myList.getModel();
  }
