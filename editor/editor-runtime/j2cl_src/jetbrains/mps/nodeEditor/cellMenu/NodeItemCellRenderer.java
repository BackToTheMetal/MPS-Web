...
class NodeItemCellRenderer extends JPanel implements ListCellRenderer<SubstituteAction> {
  ...
  private final Color HIGHLIGHT_COLOR = new Color(189, 55, 186);
  private final Color SELECTION_HIGHLIGHT_COLOR = new Color(250, 239, 215);
  ...
  private void setupThis(JList<?> list, SubstituteAction action, boolean isSelected, boolean isPrecalculating) {
    ...
    try {
      ...
      if (descriptionText != null) {
        myRight.setText(descriptionText);
      }
    } catch (Throwable t) {
  ...
  private void appendText(String pattern, JLabel component, boolean isSelected, String text, Color textColor, int style, boolean isStrikeout) {
