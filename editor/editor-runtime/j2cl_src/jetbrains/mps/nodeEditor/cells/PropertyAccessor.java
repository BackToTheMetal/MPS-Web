...
/**
 * J2CL variant: {@code @Deprecated} is reduced to a plain annotation.
 * The {@code since} and {@code forRemoval} members are not supported by the J2CL JRE emulation.
 */
...
public class PropertyAccessor implements ModelAccessor, IPropertyAccessor {
  ...
  /*package*/ static boolean validatePropertyValue(SNode node, SProperty property, Object value) {
    return ConstraintsChildAndPropFacade.checkPropertyValue(node, property, value).isEmpty();
  }
}
