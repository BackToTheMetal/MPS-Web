...
/**
 * J2CL variant: java.lang.Error is not available in the J2CL JRE emulation; replaced with java.lang.Error
 */
...
abstract class AbstractContainer<T> implements Container<T> {
  ...
  private void incSize() {
    ...
    if (mySize == Integer.MAX_VALUE) {
      throw new Error("Maximum size of this Container is " + Integer.MAX_VALUE);
    }
    mySize++;
  }
