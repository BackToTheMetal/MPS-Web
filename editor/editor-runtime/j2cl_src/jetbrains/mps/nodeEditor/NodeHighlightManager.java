...
public class NodeHighlightManager implements EditorMessageOwner {
  ...
  private void refreshMessagesCache() {
    assert javax.swing.SwingUtilities.isEventDispatchThread() : "refreshMessagesCache() should be called from EDT only";
  ...
  private List<SimpleEditorMessage> calculateMessages(EditorCell cell) {
    ...
    final List<SimpleEditorMessage> result = new ArrayList<>();
  ...
  private void refreshLeftHighlighterMessages() {
    assert javax.swing.SwingUtilities.isEventDispatchThread() : "refreshLeftHighlighterMessages() should be called from EDT only";
  ...
  public void dispose() {
    assert javax.swing.SwingUtilities.isEventDispatchThread() : "dispose() should be called from EDT only";
    myDisposed = true;
