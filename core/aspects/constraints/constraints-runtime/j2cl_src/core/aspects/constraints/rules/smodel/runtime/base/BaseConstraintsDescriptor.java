...
public class BaseConstraintsDescriptor implements ConstraintsDescriptor {
  ...
  private final List<ConstraintsDescriptor> myDirectAncestorConstraints = new ArrayList<>();
  ...
  private final HashMap<SProperty, PropertyConstraintsDescriptor> myPropertyConstraints = new HashMap<>();
  private final HashMap<SReferenceLink, ReferenceConstraintsDescriptor> myReferenceConstraints = new HashMap<>();
