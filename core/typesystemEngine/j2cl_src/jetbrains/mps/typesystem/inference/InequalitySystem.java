...
/**
 * J2CL variant: {@code gnu.trove.THashSet} is not available in the J2CL build
 * (no J2CL-compatible Trove target), so this variant uses plain {@code HashSet}.
 */
public class InequalitySystem {
  ...
  private Set<SNode> myEquals = new HashSet<>();
  private Set<SNode> mySubTypes = new HashSet<>();
  private Set<SNode> myStrongSubTypes = new HashSet<>();
  private Set<SNode> mySuperTypes = new HashSet<>();
  private Set<SNode> myStrongSuperTypes = new HashSet<>();
  private Set<SNode> myComparableTypes = new HashSet<>();
  private Set<SNode> myStrongComparableTypes = new HashSet<>();
