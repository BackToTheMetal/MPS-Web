...
public class Equations {
  ...
  @StateObject
  private final Map<SNode, SNode> myRepresentatives = new HashMap<>();
  ...
  private boolean compareTypes(SNode left, SNode right, EquationInfo info) {
    ...
    HashSet<Pair<SNode, SNode>> matchingPairs = new HashSet<>();
  ...
  public SNode expandNode(final SNode node, boolean finalExpansion) {
    return expandNode(node, new HashSet<>(), finalExpansion, true);
  }
  ...
  private void replaceChildren(SNode node, Set<SNode> variablesMet, boolean finalExpansion, boolean copy) {
    Map<SNode, SNode> childrenReplacement = new HashMap<>();
  ...
  public Set<Entry<SNode, Set<SNode>>> getEquationGroups() {
    Set<SNode> all = new HashSet<>();
    List<String> result = new LinkedList<>();
    Map<SNode, Set<SNode>> map = new HashMap<>();
