...
public final class StringUtil {
  ...
  public static boolean checkShortTitleCapitalization(@NotNull String value) {
    ...
    List<String> words = new ArrayList<>(splitWords.length);
    ...
    if (Character.isLetter(firstWord.charAt(0)) && !isCapitalizedWord(firstWord)) {
      return false;
    }
    ...
    for (int i = 1; i < wordCount; i++) {
      ...
      if (isCapitalizedWord(word)) {
        // Check for abbreviations such as "C", "SQL", and "I18n".
    ...
    return ratio <= 0.4; // Allow a reasonable number of capitalized words.
  }
