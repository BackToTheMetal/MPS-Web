...
public class StructureRegistry implements CoreAspectRegistry {
  ...
  private final Set<SLanguageId> myLanguagesWithoutAspect = Collections.synchronizedSet(new HashSet<>());
  private final Map<SConceptId, ConceptDescriptor> myConceptDescriptorsById = new HashMap<>();
