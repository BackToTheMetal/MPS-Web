...
public abstract class MetaAdapterFactory {
  private static final HashMap<Long, List<SLanguageAdapterById>> ourLanguages = new HashMap<>(200);
  ...
  private static final HashMap<Long, List<ConceptBucket>> ourConcepts = new HashMap<>(5000);
  private static final HashMap<Long, List<InterfaceBucket>> ourInterfaces = new HashMap<>(1000);
  private static final HashMap<Long, List<ConstrainedStringDataTypeBucket>> ourConstrainedStringDataTypes = new HashMap<>(1000);
  private static final HashMap<Long, List<EnumerationBucket>> ourEnumerations = new HashMap<>(1000);
  private static final HashMap<Long, List<PropertyBucket>> ourProperties = new HashMap<>(5000);
  private static final HashMap<Long, List<AssociationLinkBucket>> ourAssociations = new HashMap<>(1000);
  private static final HashMap<Long, List<AggregationLinkBucket>> ourAggregations = new HashMap<>(1000);
  ...
  private static <T> List<T> getBucketList(HashMap<Long, List<T>> map, long bucketKey) {
    //noinspection SynchronizationOnLocalVariableOrMethodParameter
    synchronized (map) {
