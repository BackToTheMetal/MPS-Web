...
public class SNodeOperations {
  ...
  private static void copyAllAttributes(SNode oldChild, SNode newChild) {
    final SConcept attrProperty = CONCEPTS.PropertyAttribute$Gb;
    final SConcept attrLink = CONCEPTS.LinkAttribute$v_;
  ...
  public static SConcept castConcept(SAbstractConcept concept, SConcept castTo) {
    return (SConcept) castConcept(concept, (SAbstractConcept) castTo);
  }
