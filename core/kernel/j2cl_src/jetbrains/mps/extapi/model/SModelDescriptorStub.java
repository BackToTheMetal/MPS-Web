...
public abstract class SModelDescriptorStub implements SModelInternal, SModel, FastNodeFinder.Factory {
  ...
  private final List<SModelListener> myModelListeners = new ArrayList<>();
  ...
  static class VersionMismatchException extends RuntimeException {
    VersionMismatchException(@Nullable Project p, org.jetbrains.mps.openapi.model.SModel modelDescriptor,
      ...
      super("Can't add language import with different version. Old version: %d; new version: %d; model: %s; language: %s");
    }
  }
}
