...
public class UniversalOptimizedNodeIdMap implements INodeIdToNodeMap {
  private final HashMap<Long, SNode> myRegularMap = new HashMap<>();
  private final HashMap<String, SNode> myStringBasedIdMap = new HashMap<>();

  private final HashMap<SNodeId, SNode> myOtherMap = new HashMap<>();
