...
public abstract class AbstractModelAccess implements ModelAccess {
  ...
  public AbstractModelAccess() {
    myReadActionDispatcher = new ActionDispatcher<ReadActionListener>(ReadActionListener::readStarted, ReadActionListener::readFinished);
    myCommandActionDispatcher = new ActionDispatcher<CommandListener>(CommandListener::commandStarted, CommandListener::commandFinished);
    myWriteActionDispatcher = new ActionDispatcher<WriteActionListener>(WriteActionListener::actionStarted, WriteActionListener::actionFinished);
  }
